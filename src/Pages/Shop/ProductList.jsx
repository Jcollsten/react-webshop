...
function ProductList() {
  const { products, addToCart, cartItems, roundedDiscount, discountedPrice } =
          ...
          return (
            ...
            >
              <li className="flex flex-col h-full">
                ...
                {discountApplied && (
                  <p className="absolute flex items-center p-1 font-semibold text-white bg-red-500 w-[10rem] rotate-45 justify-center rounded text-l top-4 left-36">
